...
\begin{document}
    ...
    \begin{table}[h]
        ...
        \label{tab:entscheidbarkeit-chomsky}
    \end{table}
    ...
    \begin{table}[h]
        ...
        \label{tab:abgeschlossenheit-chomsky}
    \end{table}
    ...
    \begin{defi}[Kodierungsschema]
        ...
        Die \tcol{Inputlänge} eines Problembeispiels ist die Anzahl der Symbole der Kodierung.
    \end{defi}
